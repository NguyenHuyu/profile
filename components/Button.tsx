...
export default function Button({ children }: { children: React.ReactNode }) {
  return (
    <div className='relative inline-block text-lg group'>
      <span className='relative z-10 block px-3 py-2 overflow-hidden font-medium text-[15px] leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white'>
